...
function StoryAction({ label, href, dark = false }) {
    ...
    <>
      ...
      <span
        className={cn(
          ...
          dark
            ? "bg-[#0d2d5b] text-white"
            : "bg-[#ecf5ff] text-[#0d4ea5]",
        )}
      >
  ...
  if (href) {
    return (
      <a
        ...
        rel="noreferrer"
        className={cn(
          "inline-flex min-h-11 w-fit max-w-full items-center gap-2 rounded-full px-4 py-2 text-[13px] font-bold transition duration-300",
          dark
            ? "border border-white/18 bg-white text-[#082349] shadow-[0_10px_26px_rgba(255,255,255,.14)] hover:-translate-y-0.5 hover:bg-[#eef7ff]"
            : "border border-[#d5e6f6] bg-white text-[#0d4ea5] shadow-[0_10px_22px_rgba(8,31,61,.05)] hover:-translate-y-0.5 hover:bg-[#f7fbff]",
        )}
      >
        {content}
      </a>
  ...
  return (
    <span
      className={cn(
        "inline-flex min-h-11 w-fit max-w-full items-center gap-2 rounded-full px-4 py-2 text-[13px] font-bold",
        dark
          ? "border border-white/14 bg-white/10 text-white"
          : "border border-[#d5e6f6] bg-white text-[#0d4ea5]",
      )}
    >
      {content}
    </span>
      ...
      <div className={cn("relative z-[1] flex h-full flex-col p-6 md:p-7")}>
        ...
        >
          ...
          <div className={cn("mt-4")}>
            <StoryAction label={sourceLabel} href={story.source_url} dark />
          </div>
        </div>
      </div>
    </article>
