      ...
      <Reveal y={22} duration={0.5}>
        <section className="page-banner">
          <div className="page-banner__copy card">
            ...
            <p>
              Официальные контакты клуба, арены и ключевых коммуникационных
        ...
        <section className="section-block contact-command">
          ...
          <div className="contact-grid">
            ...
            <article className="glass-panel glass-panel--soft">
              ...
              <p>
                Ложи, премиальные места и сценарии приёма партнёров на домашних
                матчах.
              </p>
              {partnershipUrl ? (
                <a
          ...
          <div className="results-grid">
            {recentMatches.map((match) => (
              <article
                ...
                className="result-card result-card--light"
              >
