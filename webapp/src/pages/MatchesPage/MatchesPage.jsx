      ...
      <Reveal y={22} duration={0.5}>
        <section className="page-banner page-banner--dark">
          <div className="page-banner__copy card card--dark">
            ...
            <p>
              В одном ритме собраны афиша матчей, статусы, счёт, арена и
              официальный протокол каждой встречи.
            </p>
          </div>
      ...
      <Reveal y={24} duration={0.55}>
        <section className="section-block section-block--dark match-ribbon">
          ...
          <p className="match-ribbon__stamp">
            {match_hub.updated_label
              ? `Последнее обновление ${match_hub.updated_label} МСК`
              : "Матч-центр в актуальном состоянии"}
          </p>
        </section>
      </Reveal>
      ...
      <Reveal y={24} duration={0.55}>
        <section className="section-block schedule-board">
          ...
          <div className="schedule-grid">
            {matches.map((match) => (
              <article
                key={`${match.opponent}-${match.kickoff_iso}-${match.status}`}
              ...
              >
                ...
                <div className="schedule-card__body">
                  ...
                  <strong className="scoreline scoreline--small">
                    {match.result_label}
                  </strong>
                  <span>
                  ...
                  {match.summary ? (
                    <p className="schedule-card__summary">{match.summary}</p>
                  ) : null}
