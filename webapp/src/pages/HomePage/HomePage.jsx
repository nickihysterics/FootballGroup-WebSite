...
function EditorialStoryCard({
  ...
  return (
    ...
    >
      ...
      >
        <div className="text-xs font-bold uppercase tracking-[0.14em] text-white/72">
        ...
        <h3
          className={cn(
            ...
            featured
              ? "text-[clamp(1.1rem,1.5vw,1.4rem)] leading-[1.2]"
              : "text-base leading-[1.3]",
          )}
        >
        ...
        <section className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_430px] 2xl:grid-cols-[minmax(0,1fr)_460px]">
          ...
          >
            ...
            <div className="mt-5 grid gap-3">
              ...
              <h1 className="m-0 max-w-[18ch] font-[var(--font-display)] text-[clamp(2.05rem,4vw,3.8rem)] leading-[1.06] tracking-[-0.055em] text-[#081f3d]">
                {club?.tagline}
              </h1>
