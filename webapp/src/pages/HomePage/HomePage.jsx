            ...
            {hero.featured_match ? (
              <div className="hero-spotlight hero-spotlight--dark">
                <div className="hero-spotlight__meta">
                  <span className="badge-chip badge-chip--bright">
                    Следующий матч
                  </span>
                ...
                <p>
                  {hero.featured_match.competition} ·{" "}
                  {hero.featured_match.date_label} ·{" "}
                  {hero.featured_match.time_label}
                </p>
          ...
          <div className="hero-shell__rail">
            <article className="hero-story">
              {visualImage ? (
                <img
                  src={visualImage}
                  alt={leadStory?.title || club.short_name}
                />
              ) : null}
              <div className="hero-story__overlay">
                ...
                <h2>
                  {leadStory?.title ||
                    "Кампания сезона вокруг арены и следующего матча"}
                </h2>
            ...
            <div className="hero-shell__cards">
              {hero.latest_result ? (
                <article className="hero-spotlight">
                  ...
                  <strong className="scoreline">
                    {hero.latest_result.score_for ?? "–"}:
                    {hero.latest_result.score_against ?? "–"}
                  </strong>
              ...
              {playerFocus ? (
                <Link
                  to="/team/"
                  className="hero-spotlight hero-spotlight--light"
                >
                  <span>Игрок недели</span>
                  <strong>{playerFocus.full_name}</strong>
                  <p>
                    {playerFocus.position_label} · #{playerFocus.number} ·{" "}
                    {playerFocus.compact_profile ||
                      playerFocus.bio ||
                      "Один из лидеров первой команды в текущем цикле сезона."}
                  </p>
                  <div className="hero-spotlight__footer">
      ...
      <Reveal y={24} duration={0.55}>
        <section className="section-block section-block--dark matchday-band">
          <div className="section-heading section-heading--wide">
            ...
            <h2>
              Матчдэй на «Газпром Арене»: билеты, hospitality и полный маршрут
              болельщика
            </h2>
          </div>
            ...
            {hero.latest_result ? (
              <article className="matchday-band__score">
                ...
                {hero.latest_result.source_url ? (
                  <a
                    href={hero.latest_result.source_url}
                    target="_blank"
                    rel="noreferrer"
                    className="text-link"
                  >
          ...
          <div className="matchday-band__offers">
            {club.links.membership_url ? (
              ...
              >
                ...
                <p>
                  Приоритет на домашние матчи, клубные бонусы и единый сезонный
                  маршрут болельщика.
                </p>
              </a>
            ) : null}
            ...
            {club.links.shop_url ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="offer-card offer-card--light"
              >
                <span>Магазин</span>
                <strong>Официальная экипировка</strong>
                <p>
                  Игровая форма, повседневные капсулы и фирменный мерч в одной
                  коллекции сезона.
                </p>
              </a>
            ) : null}
            ...
            {club.links.hospitality_url ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="offer-card offer-card--outline"
              >
                <span>Hospitality</span>
                <strong>Премиальные места</strong>
                <p>
                  Ложи, бизнес-клуб и премиальные сценарии для партнёров и
          ...
          <div className="ticker-row ticker-row--compact">
            {hero.match_hub.upcoming.map((item) => (
              <div
                key={`${item.opponent}-${item.kickoff_iso}`}
            ...
            {hero.match_hub.recent.map((item) => (
              <div
                key={`${item.opponent}-${item.result_label}`}
                className="ticker-pill ticker-pill--muted"
              >
                <strong>{item.opponent}</strong>
      ...
      <Reveal y={24} duration={0.55}>
        <section className="section-block arena-showcase">
          <div className="section-heading section-heading--wide">
            ...
            <h2>
              Арена как главный визуальный объект: свет, поле и матчевое
              напряжение без визуального шума
            </h2>
          </div>
          ...
          <div className="arena-showcase__grid">
            <div className="arena-stage card card--flush">
              <StadiumScene
                ...
                featuredMatch={hero.featured_match}
              />
            ...
            <div className="arena-showcase__stack">
              <article className="glass-panel glass-panel--deep">
                ...
                <h3>{club.stadium}</h3>
                <p>
                  {club.city} · домашние матчи, премиальные маршруты и главная
                  футбольная площадка клубной системы.
                </p>
              </article>
              ...
              <article className="glass-panel">
                ...
                <strong>
                  {hero.featured_match
                    ? `${hero.featured_match.date_label} · ${hero.featured_match.time_label}`
                ...
                <div className="player-card__body">
                  ...
                  <p>
                    {player.bio ||
                      ...
                      "Игровой профиль футболиста первой команды."}
                  </p>
