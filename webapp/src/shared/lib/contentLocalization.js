...
export function localizeClubProfile(club, language = "ru") {
  ...
  return {
    ...
    source_name: localizeSourceName(resolveLocalizedField(club, "source_name", language), language),
  };
}
...
export function localizeStory(story, language = "ru") {
  ...
  return {
    ...
    source_name: localizeSourceName(resolveLocalizedField(story, "source_name", language), language),
...
export function localizeGalleryItem(item, language = "ru") {
  ...
  return {
    ...
    source_name: localizeSourceName(resolveLocalizedField(item, "source_name", language), language),
  };
}
