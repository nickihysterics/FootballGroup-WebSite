...
const MESSAGES = {
  ru: {
    ...
    "home.offer.membership.eyebrow": "Абонементы",
    "home.offer.membership.title": "Сезонный доступ",
    "home.offer.membership.text": "Приоритет на домашние матчи и бонусы клубной программы.",
    "home.offer.shop.eyebrow": "Магазин",
    "home.offer.shop.title": "Официальная экипировка",
    "home.offer.shop.text": "Форма, капсулы и фирменный мерч в одной коллекции сезона.",
    "home.offer.hospitality.title": "Премиальные места",
    "home.offer.hospitality.text": "Ложи, бизнес-клуб и премиальный сценарий посещения матча.",
    ...
    "home.matchdayDescription": "Билеты, hospitality, результат недели и ближайшие матчи — в одном собранном блоке.",
    ...
    "home.galleryTitle": "Matchday и клубные кадры",
    ...
    "contacts.routesEyebrow": "Маршруты",
    "contacts.routesTitle": "Куда перейти дальше",
    "contacts.route.official.title": "Официальный ресурс",
    "contacts.route.official.description": "Новости, публикации и основные сервисные разделы клуба.",
    "contacts.route.membership.title": "Абонементы",
    "contacts.route.membership.description": "Сезонные программы и маршруты для болельщиков.",
    "contacts.route.shop.title": "Магазин",
    "contacts.route.shop.description": "Фирменный мерч и официальные клубные товары.",
    "contacts.route.hospitality.description": "Премиальные места и коммерческие форматы посещения.",

    "footer.arena": "Арена",
    "footer.communications": "Коммуникации",
    "footer.routes": "Маршруты",
  ...
  en: {
    ...
    "common.memberships": "Memberships",
    "common.shop": "Shop",
    "common.hospitality": "Hospitality",
    ...
    "home.offer.membership.eyebrow": "Memberships",
    "home.offer.membership.title": "Season access",
    "home.offer.membership.text": "Priority for home matches and extra club-program perks.",
    "home.offer.shop.eyebrow": "Shop",
    "home.offer.shop.title": "Official kit",
    "home.offer.shop.text": "Kits, capsules and club merchandise in one season collection.",
    "home.offer.hospitality.title": "Premium seats",
    "home.offer.hospitality.text": "Boxes, business club access and a premium matchday experience.",
    ...
    "contacts.routesEyebrow": "Routes",
    "contacts.routesTitle": "Where to go next",
    "contacts.route.official.title": "Official resource",
    "contacts.route.official.description": "News, publications and the main service sections of the club.",
    "contacts.route.membership.title": "Memberships",
    "contacts.route.membership.description": "Season programs and supporter paths.",
    "contacts.route.shop.title": "Shop",
    "contacts.route.shop.description": "Official merchandise and club goods.",
    "contacts.route.hospitality.description": "Premium seating and commercial attendance formats.",
