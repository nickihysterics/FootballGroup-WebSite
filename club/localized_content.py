...
def localize_source_name(value: str, language: str) -> str:
    return localize_exact(value, language, SOURCE_NAME_MAPS, fallback="latin" if language == "en" else "cyrillic")
