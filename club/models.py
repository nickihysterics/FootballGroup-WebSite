...
class ClubProfile(LocalizedFieldsMixin, TimestampedModel):
    ...
    hero_badge = models.CharField(
        "Подпись hero", max_length=120, default="Газпром футбольная программа"
    )
    ...
    source_name_ru = models.CharField(
        "Источник данных (RU)", max_length=120, blank=True, default=""
    )
    source_name_en = models.CharField(
        "Источник данных (EN)", max_length=120, blank=True, default=""
    )
...
class Player(LocalizedFieldsMixin, TimestampedModel):
    ...
    place_of_birth_ru = models.CharField(
        "Место рождения (RU)", max_length=160, blank=True, default=""
    )
    place_of_birth_en = models.CharField(
        "Место рождения (EN)", max_length=160, blank=True, default=""
    )
    ...
    previous_club_ru = models.CharField(
        "Предыдущий клуб (RU)", max_length=160, blank=True, default=""
    )
    previous_club_en = models.CharField(
        "Предыдущий клуб (EN)", max_length=160, blank=True, default=""
    )
